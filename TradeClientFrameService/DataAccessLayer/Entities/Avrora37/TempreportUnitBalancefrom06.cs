...
{
    public partial class TempreportUnitBalancefrom06
    {
        ...
        public decimal? _33ОбработаноКВоАртикуловНаТтЗаСуткиС800До800 { get; set; }
        public decimal? _34ОбработаноКВоСтрокЗаказаНаТтЗаСуткиС800До800 { get; set; }
        ...
        public decimal? _62РаспределеноВсегоКВоАртикулов { get; set; }
        public decimal? _63РаспределеноВсегоСуммаЦз { get; set; }
        public decimal? _71ФактическиПоступилоВсегоЮнитов { get; set; }
        public decimal? _72ФактическиПоступилоВсегоКВоАртикулов { get; set; }
