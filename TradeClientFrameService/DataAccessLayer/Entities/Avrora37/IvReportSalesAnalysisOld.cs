...
{
    public partial class IvReportSalesAnalysisOld
    {
        ...
        public string NotReceiveInfo { get; set; }
        public string NotReceiveEmail { get; set; }
        public string NotReceiveSms { get; set; }
