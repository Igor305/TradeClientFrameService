...
{
    public partial class TCret
    {
        public TCret()
        {
            TCretRoutes = new HashSet<TCretRoute>();
            TCretSpends = new HashSet<TCretSpend>();
        }
        ...
        public virtual ICollection<TCretRoute> TCretRoutes { get; set; }
        public virtual ICollection<TCretSpend> TCretSpends { get; set; }
    }
}
